...
<body>
    ...
    <div class="response-message">
        <h2>Log-in Successful, ${name}!</h2>
        <p>Thank you for registering for the New Year Party. We are thrilled to have you with us!</p>
        <div class="party-invite">
            <p>You are invited to attend the New Year Party. We look forward to celebrating with you!</p>
        </div>
    </div>
